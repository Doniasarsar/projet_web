<?php
	...
	if (
        isset($_POST["CIN_medecin"]) 
    ){
		if (
            !empty($_POST["CIN_medecin"]) 
        ) {
            $medecin = new medecin(
                $_POST['CIN_medecin'],
				'',
            ...
            $medecinC->recherchermedecin($_POST['CIN_medecin']);
        }
        else
...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
        ...
        <form action="" method="POST">
			<table align="center">
				<tr>
                    <td>
                        <label for="CIN_medecin">CIN_medecin a rechercher:
                        </label>
                    </td>
                    <td><input type="number" name="CIN_medecin" id="CIN_medecin" maxlength="20" ></td>
                </tr>
                <tr>
                    <td></td>
                    <td>
