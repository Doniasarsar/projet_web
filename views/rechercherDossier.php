<?php
	...
	if (
		...
		if (
            ...
            $dossierC->rechercherDossier($_POST['idDossier']);
        }
        else
...
<?php include ('./front/header.html'); ?>
        ...
        <form action="" method="POST">
			<table align="center">
				<tr>
                    <td>
                        <label for="idDossier">idDossier a rechercher:
                        </label>
                    </td>
                    <td><input type="number" name="idDossier" id="idDossier" maxlength="20" ></td>
                </tr>
                <tr>
                    <td></td>
                    <td>
