<?php
	...
	if (
		...
		if (
            ...
            $secretaireC->modifiersecretaire($secretaire);
        }
        else
		...
		<form action="" method="POST">
            <table align="center">
                <tr>
                    ...
                    <td><input type="number" name="CIN" id="CIN" maxlength="8" disabled value = "<?php echo $secretaire['CIN_secretaire']; ?>">
					<input type="hidden" name="CIN_secretaire" id="CIN_secretaire" value = "<?php echo $secretaire['CIN_secretaire']; ?>"></td></td>
                </tr>
				<tr>
                    <td>
                    ...
                    <td><input type="text" name="Nom_secretaire" id="Nom_secretaire" minlength="3" maxlength="20" value = "<?php echo $secretaire['Nom_secretaire']; ?>"></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="text" name="Prenom_secretaire" id="Prenom_secretaire" minlength="3" maxlength="20" value = "<?php echo $secretaire['Prenom_secretaire']; ?>"></td>
                </tr>
                 <tr>
                    <td>
                    ...
                    <td><input type="date" name="date_secretaire" id="date_secretaire"min="1900-01-01" max="2002-01-01" value = "<?php echo $secretaire['date_secretaire']; ?>"></td>
                </tr>
				<tr>
                    <td>
                    ...
                    <td><input type="text" name="Login_secretaire" id="Login_secretaire" value = "<?php echo $secretaire['Login_secretaire']; ?>"></td>
                </tr>
				<tr>
                    <td>
                    ...
                    <td><input type="password" name="MDP_secretaire" id="MDP_secretaire" minlength="8" maxlength="20" value = "<?php echo $secretaire['MDP_secretaire']; ?>"></td>
                </tr>
				<tr>
                    <td>
                    ...
                    <td><input type="number" class="form-control" id="phone_secretaire" name="phone_secretaire" value = "<?php echo $secretaire['phone_secretaire']; ?>"></td>
                </tr>
				<tr>
                    <td>
                        <label for="Adresse_secretaire">Adress:
                        </label>
                    </td>
                    <td>
                        <input type="text" name="Adresse_secretaire" id="Adresse_secretaire" minlength="8" maxlength="100" value = "<?php echo $secretaire['Adresse_secretaire']; ?>">
                    </td>
                </tr>
