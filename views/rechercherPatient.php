<?php
	...
	if (
		...
		if (
            ...
            $patientC->rechercherPatient($_POST['CIN_patient']);
        }
        else
...
<?php include ('./front/header.html'); ?>
		...
		<button><a href="showPatients.php">Retour à la liste</a></button>
        <hr>
        <form action="" method="POST">
			<table align="center">
				<tr>
                    <td>
                        <label for="CIN_patient">CIN_patient a rechercher:
                        </label>
                    </td>
                    <td><input type="number" name="CIN_patient" id="CIN_patient" maxlength="20" ></td>
                </tr>
                <tr>
                    <td></td>
                    <td>
