<?php
	...
	if (
		...
		if (
            ...
            $dossierC->modifierDossier($dossier,$_GET['idDossier']);
        }
        else
		...
		<form action="" method="POST">
            <table align="center">
                <tr>
                    ...
                    <td><input type="text" name="date_dossier" id="date_dossier" maxlength="20" required value = "<?php echo $dossier['date_dossier']; ?>"></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="text" name="description_dossier" id="description_dossier" maxlength="100" required value = "<?php echo $dossier['description_dossier']; ?>"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="observation_dossier" id="observation_dossier" maxlength="100" required value = "<?php echo $dossier['observation_dossier']; ?>">
                    </td>
                </tr>
